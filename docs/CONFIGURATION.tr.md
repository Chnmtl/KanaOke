...
> 🌐 **Dil / Language:** **Türkçe** · [English](CONFIGURATION.md)

Bu belge, KanaOke uygulamasının yapılandırması, ortam değişkenleri, mimarisi ve proxy ayrıntılarını içerir. Genel tanıtım ve hızlı kurulum için ana [README](../README.tr.md) dosyasına bak.
